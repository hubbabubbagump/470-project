...
<html>
    <head>
  	...
  	<body class= "loginContainer" id="formbody">
		...
		<form onsubmit="event.preventDefault(); return sendEdit()" name="editItemForm">
			<fieldset>
			...
			<input type="text" name="faculty" pattern="[A-Za-z]{2,}"  value="<?php echo set_value('faculty', $faculty); ?>"/><br/>

			<label class="required"><b>Course Number</b></label><br/>
			<input type="text" name="courseNum" pattern = "[0-9]{3}" value="<?php echo set_value('courseNum', $courseNum); ?>"/><br/>
